 ...
 router.post('/confirmReserved',auth, catchAsync(async (req, res, next) => {
  ...
  for (i = 0; i < parseInt(details.Children); i++) {
    ...
    var mailOptions = {
      ...
      text: 
      `Here is your round Ticket Info for Passenger ${details.ChildrenNames[i]}
      Departure Flight Number:${goingflight.FlightNumber},
      Return Flight Number:${returnflight.FlightNumber},
      Departure Ticket Number: ${ticketgoing._id},
      Return Ticket Number: ${ticketreturn._id},
      From: ${goingflight.From.Airport},
      To: ${goingflight.To.Airport},
      Class: ${details.Cabin},
      Departure Date: ${goingflight.Departure.Date},
      Return Date :${returnflight.Departure.Date}
     Going Flight Departs At: ${goingflight.Departure.Time},
     Going Flight Arrives At: ${goingflight.Arrival.Time},
     Return Flight Departs At: ${returnflight.Departure.Time},
     Return Flight Arrives At: ${returnflight.Arrival.Time},
     Going Flight Departure Terminal: ${goingflight.From.Terminal},
     Going Arrival Terminal: ${goingflight.To.Terminal}
     Return Flight Departure Terminal: ${returnflight.From.Terminal}},
     Return Arrival Terminal: ${returnflight.From.Terminal}`}
