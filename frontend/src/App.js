...
import ChangeSeat from './components/ChangeSeat.js';
...
function App() {
  ...
  return ( 
    ...
    <Routes>
    <Route path="/authorize/logout" element={<SignOut/>}/>
      ...
      <Route path="/user/changeSeats/:FlightId/:Cabin/:TicketId/:OldSeat" element={<ChangeSeat/>}/> 
