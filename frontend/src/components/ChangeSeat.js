  ...
  async function handleReserve(chosenSeatId) {
    ...
    return (
      ...
      <NavBarUser></NavBarUser>
        ...
        <Container className='mt-5 mb-5' style={ {marginTop:'20%'}} >
...
<a align="center" style={(Error)?{display: 'block',color:'red',fontSize:'20px',marginTop:'30%'}:{display: 'none'}}><CardTitle>{Msg}</CardTitle></a></Alert></Col> 
&&
<Link  to={{pathname:`/user/viewReserved` 
                        
                           }}className="btn btn-primary " style={{color:'#FFFFFF',backgroundColor:'#d4902a',marginTop:'30%'}}>View My tickets</Link> }
            </Container>
            </>
     )
}
