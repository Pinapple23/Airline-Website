...
{(ticket.Seat.SeatId===null)?<></>:<Button><Link to={{ pathname:`/user/changeSeats/${ticket.Flight.FlightId}/${ticket.Cabin}/${ticket._id}/${ticket.Seat.SeatId}`}}> Change Seat </Link></Button>}
